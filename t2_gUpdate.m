...
elseif rfun=='N'
    ...
    disp('It should be clarified if rho is a function of time or not (Line 9, input file)')
end
...
while cond<1
    i=i+1;
    ti(i)=ti(i-1)+h;
    dfdy=[((double(subs(rho,ti(i)))-Beta)/A) La; (B(1)/A) -La(1) La(2) La(3) La(4) La(5) La(6);
        (B(2)/A) La(1) -La(2) La(3) La(4) La(5) La(6);
        (B(3)/A) La(1) La(2) -La(3) La(4) La(5) La(6);
        (B(4)/A) La(1) La(2) La(3) -La(4) La(5) La(6);
        (B(5)/A) La(1) La(2) La(3) La(4) -La(5) La(6);
        (B(6)/A) La(1) La(2) La(3) La(4) La(5) -La(6)];
    dfdt=[((double(subs(drho,ti(i)))*(yall(2,i)))/A);0;0;0;0;0;0]; %df/dt
    f0=dfdy*y0; %initial f
    [L,U]=lu(((1./(gam*h)))-dfdy); %LU decompisition of LHS of eqns 3 in the paper, based on h=0.01
    g1=(f0+(h.*c1.*dfdt))/norm(L*U); %g1 initial calculation
    g2=((([((double(subs(rho,(a2*h)))-Beta)/A) La; (B(1)/A) -La(1) La(2) La(3) La(4) La(5) La(6);
        (B(2)/A) La(1) -La(2) La(3) La(4) La(5) La(6);
        (B(3)/A) La(1) La(2) -La(3) La(4) La(5) La(6);
        (B(4)/A) La(1) La(2) La(3) -La(4) La(5) La(6);
        (B(5)/A) La(1) La(2) La(3) La(4) -La(5) La(6);
        (B(6)/A) La(1) La(2) La(3) La(4) La(5) -La(6)])*(y0+(a21*g1)))+(h.*c2.*dfdt)+((c21*g1)/h))/norm(L*U); %g2 initial calculation
    g3=((([((double(subs(rho,(a3*h)))-Beta)/A) La; (B(1)/A) -La(1) La(2) La(3) La(4) La(5) La(6);
        (B(2)/A) La(1) -La(2) La(3) La(4) La(5) La(6);
        (B(3)/A) La(1) La(2) -La(3) La(4) La(5) La(6);
        (B(4)/A) La(1) La(2) La(3) -La(4) La(5) La(6);
        (B(5)/A) La(1) La(2) La(3) La(4) -La(5) La(6);
        (B(6)/A) La(1) La(2) La(3) La(4) La(5) -La(6)])*(y0+(a31*g1)+(a32*g2)))+(h.*c3.*dfdt)+(((c31*g1)+(c32*g2))/h))/norm(L*U);%g3 initial calculation
    g4=((([((double(subs(rho,(a3*h)))-Beta)/A) La; (B(1)/A) -La(1) La(2) La(3) La(4) La(5) La(6);
        (B(2)/A) La(1) -La(2) La(3) La(4) La(5) La(6);
        (B(3)/A) La(1) La(2) -La(3) La(4) La(5) La(6);
        (B(4)/A) La(1) La(2) La(3) -La(4) La(5) La(6);
        (B(5)/A) La(1) La(2) La(3) La(4) -La(5) La(6);
        (B(6)/A) La(1) La(2) La(3) La(4) La(5) -La(6)])*(y0+(a31*g1)+(a32*g2)))+(h.*c4.*dfdt)+(((c41*g1)+(c42*g2)+(c43*g3)))/h)/norm(L*U); %g4 initial calculation
